...
import styles from './YarnDetail.module.scss';
...
const YarnDetail = () => {
    ...
    return (
        <wrapper>
            <Nav/>
            <Container id={styles.yarnDetailContainer} maxWidth="xl">
                <div className={styles.yarnDetailContent}>
                    ...
                    <img alt="old yarn admin dashboard" style={{width: '100%'}} src={YarnDash} />
                    ...
                    <img alt="mobile story sample" style={{width: '40%'}} src={MobileSample} />
                    <h3>Redesign</h3>
                    ...
                    <img alt="demo of new version csv upload" style={{width: '100%'}} src={RegularUp} />
                    ...
                    <img alt="demo of new version missing character popup" style={{width: '100%'}} src={MissingChar} />
                    ...
                    <img alt="demo of new version mobile screen size selection" style={{width: '100%'}} src={ScreenSize} />
                    <h3>Next Steps</h3>
                    <ul>
